    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                if (args.Length < 1)
                {
                    oApp = new Application(); // here automatic created the application based on the Framework library.
                }
                else
                {
                ...
                MyMenu.BasicStart();
                SAPSalesOrder objso;
                objso = new SAPSalesOrder();
                oApp.RegisterMenuEventHandler(MyMenu.SBO_Application_MenuEvent);
                ///Application.SBO_Application.ItemEvent+=new SAPbouiCOM.
